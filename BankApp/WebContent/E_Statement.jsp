<%@page import="admin.Bean_AdminBanking"%>
...
<body bgcolor="#D0D0CE">
	...
	<nav align="center">
        ...
        st = objectList.get(0).getAccount_number();
		
		
		Query query1 = se.createQuery("FROM Bean_AdminBanking  where accountnumber='"+st+"'"); 
        List<Bean_AdminBanking> objectList1 =  query1.list();
       %>
       
       <table cellpadding="5px;" cellspacing="10px;" style="margin-left: 300px; border: 1px solid black; column-rule: 2px;">
			<tr>
				<td>Date</td>
				<td>To/By</td>
				<td>Credit</td>
			...
			<tr align="center">
				...
				<td><input type="text" id="acc" readonly="readonly" value="<%= objectList1.get(i).getDate()%>"></td>
				<td><input type="text" id="acc" readonly="readonly" value="<%= objectList1.get(i).getFromwhom()%>"></td>
				<td><input type="text" id="acc" readonly="readonly" value="<%= objectList1.get(i).getCreditamount()%>"></td>
				<td><input type="text" id="acc" readonly="readonly" value="<%= objectList1.get(i).getDebitamount()%>"></td>
